        ...
        <div id="listHeader">
          ...
          <div id="listTextContainer">
            <p id="p1" className="listText">
              ...
              drum loop, a vocal a cappella or lyrics - just start your own
              music collaboration project and upload your idea. Then, wait for
              others to join in, or send invites to other members. You can also
              jump in on any other open project by uploading your idea as an
              audition.
            </p>
            <p id="p2" className="listText">
              MindLink allows members to upload and manage their work in a
              collaborative project environment where others can later upload
              and download tracks and work on them at their own convenience.
            </p>
          </div>
        </div>
        <div>
